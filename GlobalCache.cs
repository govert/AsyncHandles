...
namespace AsyncHandles
{
    class GlobalCache
    {
        ...
        internal static object CreateHandleAsync(string objectType, object[] parameters, Func<string, object[], Task<object>> makerAsync)
        {
            return m_storage.CreateHandleAsync(objectType, parameters, makerAsync);
        }
